...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'].'/sofyanperkasamandiri.co.id/asset/',
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../../asset/attachments/source/',
	...
	|
	*/
	'thumbs_base_path' => '../../../../../asset/attachments/thumbs/',
	...
	*/
	...
	|---------------------------------------------------------------------------
	*/
	'ftp_thumbs_dir' => '/attachments/thumbs/',
	'ftp_ssl' => false,
	'ftp_port' => 21,
