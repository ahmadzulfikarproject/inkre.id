...
?><div class="bDiv" >
		...
		<thead>
			<tr class='hDiv'>
				...
				<th <?php echo ( isset($column->th_style_string) && $column->th_style_string != "" ) ? 'style="'.$column->th_style_string.'"' : '';?> >
...
<?php foreach($list as $num_row => $row){ ?>        
		<tr  <?php if($num_row % 2 == 1){?>class="erow"<?php }?>>
			<?php foreach($columns as $column){?>
			<td class='<?php if(isset($order_by[0]) &&  $column->field_name == $order_by[0]){?>sorted<?php }?>' <?php echo ( isset($column->td_style_string) && $column->td_style_string != "" ) ? 'style="'.$column->td_style_string.'"' : '';?> >
