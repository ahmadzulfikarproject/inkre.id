...
<?php
	if(isset($multisearch) && !$multisearch){
?>
<!-- Original -->
...
<!-------------------------- Edit-1 starts -------------------------------------------------------------------------------------------------------------->
		<div style="padding: 10px;">		
			<table class="tablez table-stripedz table-hoverz">
			   <tr>
				<td>
					Basic Search &nbsp;&nbsp;
				</td>
				...
				<td><a href="#" class="btncari btn btn-lg btn-primary" style="display:none; margin-left: 10px;">Filter Data Lengkap</a></td>
			   </tr>
			</table>
		</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                			<div style="display:none;" id="advanced_search_<?php echo $unique_hash; ?>">
								<table>
								  <?php $script = ''; $c=0;  foreach($columns_for_search as $column){
								...
								?>
								 ...
								 <input  type="button" value="<?php //echo $this->l('list_search');?>" class="crud_searchz hidden" id='crud_searchz'>
							</div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" value="<?php echo $this->l('list_search');?>" class="btn btn-primary crud_search" id='crud_search'><?php echo $this->l('list_search');?></button>
                </div>
            </div>
        </div>
    </div>
