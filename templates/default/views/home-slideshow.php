    ...
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        ...
        <div class="col-8 slide-caption">
            ...
            <h1 class="mb-2 text-white font-weight-light text-uppercase font-weight-bold"><?php echo $row['judul'] ?></h1>
            <p class="mb-5 slide-caption-description hidden-xs"><?php echo $isi ?></p>
            <p class="slide-caption-btn hidden-xs"><a href="<?php echo base_url(''); ?>" class="btn btn-whitez btn-primary btn-outline-white py-3 px-5 rounded-0 btn-2">See Details</a></p>
