    ...
    <div class="container">
        <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
                <h1 class="text-white font-weight-light text-uppercase">News</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            ...
            foreach ($berita->result_array() as $row) {
                ...
                $isi = $isi_berita ? substr($isi_berita, 0, strrpos($isi, " ")) . '...' : '';
            ...
            ?>
                ...
                <div class="col-xs-12 col-sm-12 col-sm-heightz col-sm-heightz col-lg-heightz col-topz mb-3" data-aos="fade-up" data-aos-delay="0">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="responsive-container">
                                <div class="dummy50"></div>
                                <a href="<?php echo base_url() . "berita/detail/" . $row['slug']; ?>" class="img-container" style="background-image: url(<?php echo base_url() . "asset/foto_berita/" . $foto; ?>);">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                            <small class='date pull-leftz'><span class='glyphicon glyphicon-time'></span> <?php echo $hari . ', ' . $tanggal ?></small>
