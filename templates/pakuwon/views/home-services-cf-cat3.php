...
?>
<?php if ($jumlah > 1) : ?>
  <section id="Services" class="ftco-sectionz ftco-properties bg-secondary text-white" style="padding: 60px 0px;">
    <div class="container">
      <div class="row justify-content-center mb-5 pb-3">
        <div class="col-md-7 border-primary text-center ftco-animate">
          <h2 class="font-weight-light text-white">Site Plant</h2>
          <span class="subheading">Amor Tower</span>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="services-slider-3 owl-carousel ftco-animate">
