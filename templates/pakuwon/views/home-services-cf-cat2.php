<?php
$services = $this->model_utama_services->semua_services_categories(0, 12, 4, 'DESC')->result_array();
//print_r($services);
$pages = array_chunk($services, 3);
$no = 1;
$totalpage = count($pages);
$jumlah = $this->model_utama_services->semua_services_categories(0, 12, 4, 'DESC')->num_rows();
    ...
    <div class="container">
      <div class="row justify-content-center mb-5 pb-3">
        <div class="col-md-7 border-primary text-center ftco-animate">
          <h2 class="font-weight-light text-white">Fasilitas</h2>
          <span class="subheading">Amor Tower</span>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
