	...
	<div class="container">
		<div class="row align-items-center justify-content-center text-center">
			...
			<div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
				...
				<!-- <p class="breadcrumb-custom"><a href="index.html">Home</a> <span class="mx-2">&gt;</span> <span>projects</span></p> -->
			</div>
		</div>
	</div>
</div>
						...
						foreach ($posts as $post) : ?>
							...
							<div class="col-sm-4 col-sm-heightz col-md-heightz col-lg-heightz col-topz item-list">
								<div class="h-entry" data-aos="fade-up" data-aos-delay="0">
									...
									<h2 class="font-size-regular"><a href='<?php echo base_url() . "projects/detail/" . $post['slug']; ?>'><?php echo $post['judul'] ?></a></h2>
	...
	function searchFilter(page_num) {
		...
		$.ajax({
			...
			beforeSend: function() {
				...
				//$('#projects-list .item-list').fadeOut("fast");
			...
			success: function(html) {
				...
				$('.loading').fadeOut("fast", function() {
					...
					//$('#projects-list .item-list').hide().fadeIn();
