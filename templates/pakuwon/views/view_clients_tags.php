    ...
    <div class="container" data-aos="fade-up" data-aos-once="true">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <h1>clients <?php echo $title; ?></h1>
                <div class="pull-right"><a href="<?php echo base_url('clients/tags/feed'); ?>">Site Map <ion-icon name="logo-rss"></ion-icon></a><br></div>
            </div>
        </div>
        <div class="row">
                    ...
                    foreach ($tags->result_array() as $row){
                        ...
                        <div class="col-sm-3 col-sm-heightz col-md-heightz col-lg-heightz col-topz">
                            ...
                            <div class="responsive-container kotak-item schfx" itemscope>
                                ...
                                <div class="dummy"></div>
                                <div class="img-container" style="background-image: url('<?php echo base_url()."asset/foto_clients/".$foto ;?>');">
                                  <div class="centerer"></div>
                                  <img alt="<?php echo $row['judul'] ?>" class='img-thumbnail hidden' src='<?php echo base_url()."asset/foto_clients/".$foto ;?>' class='img-responsive'>                           
                              </div><!--img-container-->
