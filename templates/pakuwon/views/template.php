...
<body onload="reload()">
  ...
  <?php endif; ?>
  <footer class="site-footer site-blocks-coverz overlay call" style="background-image: url(<?php //echo home_url() . 'asset/settings/' . setting('site_bg1'); 
                                                                                            ?>);" data-stellar-background-ratio="0.5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div id="top-header" class=" text-white text-center bg-primaryz text-white p-sm-5 hidden">
            <div class="container">
