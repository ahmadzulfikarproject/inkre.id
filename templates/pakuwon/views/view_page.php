<div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(<?php echo base_url() . "asset/foto_statis/" . $record['gambar'] ?>);" data-aos="fade" data-stellar-background-ratio="0.5">
	<div class="container">
			...
			<div class='col-md-12'>
				<div class="kontenpage hero row">
					<?php if ($record['gambar'] != '') : ?>
						<div class="col-md-3 hidden ml-auto mb-5 order-md-2">
