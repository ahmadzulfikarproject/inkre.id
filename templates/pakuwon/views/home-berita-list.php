...
?>
<?php if ($jumlah > 1) : ?>
    <section id="berita" class="ftco-section ftco-properties bg-primary text-white-50">
        <div class="container">
            <div class="row justify-content-center mb-5 pb-3">
                <div class="col-md-7 text-center border-primary">
                    <h2 class="font-weight-light text-white">Our Blog</h2>
                    <p class="text-white-50">See Our Daily News &amp; Updates</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="blog-slider owl-carousel ftco-animate">
                        <?php foreach ($berita as $ads => $row) : ?>
                            ...
                            ?>
                            <div class="item mb-5" data-aos="fade-up" data-aos-delay="400">
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col-md-6 slide-caption h-entry">
                                        <h5 class="font-size-regular"><a href="<?php echo base_url() . "berita/detail/" . $row['slug']; ?>" class="text-white"><?php echo $row['judul'] ?></a></h5>
