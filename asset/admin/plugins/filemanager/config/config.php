...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'].'/alphajayatehnik.co.id/',
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../attachments/source/',
	...
	|
	*/
	'thumbs_base_path' => '../../../../attachments/thumbs/',
