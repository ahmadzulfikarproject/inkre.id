...
class Ajax_pagination{
    ...
    var $last_link       = 'Last';
    var $uri_segment     = 3;
    var $full_tag_open   = '<ul class="pagination pg-blue justify-content-center">';
    ...
    function create_links(){
        ...
        if ($num_pages == 1){
            ...
            //custom fikar
            return  '<hr>'.$this->full_tag_open.'<li class="numpage">'.$info.' </li>'.$this->full_tag_close;
        }
        ...
        if ($this->show_count){
            ...
            //$output .= $info;
            $output .= '<li class="numpage">'.$info.' </li>';
        }
        ...
        $output = '<hr>'.$this->full_tag_open.$output.$this->full_tag_close;
        ?>
        <script>
