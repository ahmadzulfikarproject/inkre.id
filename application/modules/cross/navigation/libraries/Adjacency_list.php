...
class Adjacency_list
{
	...
	*/
	...
	{
		$this->load->config('navigation/adjacency_list', TRUE);
		$this->lang->load('navigation/adjacency_list');
		$this->load->model('navigation/adjacency_list_model');
		$this->load->helper('navigation/adjacency_list');
