<div class="bs-example">
    ...
    <div id="chat" class="hidden-xsz hidden-mdz hidden">
        <div class="btn-group">
            <!-- <button type="button" id="toggle-modal" data-target="#myModal" class="btn btn-danger toggle-modalz"><i class="fas fa-paper-plane" style="margin:0 10px 0 0"></i> Inquiry Letter</button> -->
                    ...
                    <div class="inquery">
                        ...
                        <form method="post" id="enquiry_form" autocomplete="on">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" name="subjek" id="subjek" value="" placeholder="Subjek" required>
                            </div>
...
<script>
    var jQuery.fn.tooltip = _tooltip;
</script>
<script>
...
<script type="text/javascript">
    ...
    function reload() {
        ...
        jq("#reload-captcha").trigger('click');
    }
    var jq = $.noConflict();
    jq(document).ready(function() {
        ...
        jq(".reload-captcha").click(function() {
            // alert('test');
            /*
            $.get("<?php //echo site_url('enquiry/reload_captcha');
