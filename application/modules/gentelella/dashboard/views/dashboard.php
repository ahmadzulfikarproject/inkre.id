...
// print_r($this->template->active_link);
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="btn-group pull-right">
			<?php if ($this->ion_auth->in_group('superadmin')) : ?>
				<a href="#backupModal" class="btn btn-lg btn-primary btn-sm" data-toggle="modal">Backup DB</a>
			<?php endif; ?>
		</div>
	</div>
</div>
...
<div id="backupModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<!--<a id="reset-db" href='<?php
																		?>' class='btn-default btn btn-sm'>Reset</a>-->
				<button id="backup_data" type="button" class="btn btn-primary" data-dismiss="modal">backup</button>
			</div>
		</div>
	</div>
</div>
...
<script>
	...
	$("#backup_data").click(function() {
		...
		//{
		$.ajax({
			url: '<?php echo base_url(); ?>settings/backup_data',
			type: 'GET',
			beforeSend: function() {
				//$('#enquiryList').hide();
