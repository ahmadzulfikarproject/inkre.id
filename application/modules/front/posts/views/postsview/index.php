...
<html lang="">
	...
	<body>
		...
		<div class="container">
		    <h1>Ajax Pagination with Search in CodeIgniter HMVC</h1>
		    ...
		    <div class="row">
		        ...
		        <div class="post-list col-xs-12" id="postList">
		...
		function searchFilter(page_num) {
		    ...
		    $.ajax({
		        ...
		        beforeSend: function () {
		        	//$('#postList').hide();
		        	//$('#postList').slideUp('slow');
		        	$('#postList table tbody').fadeOut("fast");
		            $('.loading').show();
		        },
		        success: function (html) {

		            //$('#postList').html(html).fadeIn('fast');
		            
		            //$('#postList').html(html).slideDown('slow');
		            //$('.loading').fadeOut("slow");
		            $('.loading').fadeOut( "fast", function() {
                        // Animation complete.
                        $('#postList').html(html);
		            	$('#postList table tbody').fadeIn('fast');
                    });
		            //alert('failure');
		        }
		    });
