...
<section id="page" class="services_categories site-section">
    <div class="container">
        <div class="row">
                    ...
                    foreach ($tags->result_array() as $row) {
                        ...
                        if ($row['gambar'] == '') {
                            ...
                            if (!file_exists("asset/foto_services/" . $foto)) {
                                if (file_exists("asset/foto_services/" . $row['gambar'])) {
                                    $foto = $row['gambar'];
                                } else {
                                    $foto = 'nophoto.jpg';
                                }
                        ...
                        <div class="col-sm-4 col-sm-heightz col-md-heightz col-lg-heightz col-topz">
                            ...
                            <div class="h-entry" data-aos="fade-up" data-aos-delay="0">
                                <div class="responsive-container box-item schfx" itemscope>
                                    ...
                                    <a href="<?php echo base_url() . "services/detail/" . $row['slug']; ?>" class="img-container" data-toggle="tooltip" data-placement="top" title="<?php echo $row['judul'] ?>" style="background-image: url('<?php echo base_url() . "asset/foto_services/" . $foto; ?>');">
                                        <div class="centerer"></div>
                                        <img alt="<?php echo $row['judul'] ?>" class='img-thumbnailz hidden' src='<?php echo base_url() . "asset/foto_services/" . $foto; ?>' class='img-responsive'>
                                    </a>
                                    <!--img-container-->

                                </div>
                                <!--responsive-container-->
                                <h2 class="font-size-regular"><a href='<?php echo base_url() . "services/detail/" . $row['slug']; ?>'><?php echo $row['judul'] ?></a></h2>
