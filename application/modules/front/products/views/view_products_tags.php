                        ...
                        <div class="col-sm-4 col-sm-heightz col-md-heightz col-lg-heightz col-topz">
                            ...
                            <div class="h-entry" data-aos="fade-up" data-aos-delay="0">
                                <div class="responsive-container box-item schfx" itemscope>
                                    ...
                                    <a href="<?php echo base_url() . "products/detail/" . $row['slug']; ?>" class="img-container" data-toggle="tooltip" data-placement="top" title="<?php echo $row['judul'] ?>" style="background-image: url('<?php echo base_url() . "asset/foto_products/" . $foto; ?>');">
                                ...
                                <h2 class="font-size-regular"><a href='<?php echo base_url() . "products/detail/" . $row['slug']; ?>'><?php echo $row['judul'] ?></a></h2>
