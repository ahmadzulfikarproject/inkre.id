						...
						foreach ($posts as $post) : ?>
							...
							<div class="col-sm-4 col-sm-heightz col-md-heightz col-lg-heightz col-topz item-list">
								<div class="h-entry" data-aos="fade-up" data-aos-delay="0">
									...
									<h2 class="font-size-regular"><a href='<?php echo base_url() . "gallery/detail/" . $post['slug']; ?>'><?php echo $post['judul'] ?></a></h2>
	...
	function searchFilter(page_num) {
		...
		$.ajax({
			...
			beforeSend: function() {
				...
				//$('#gallery-list .item-list').fadeOut("fast");
			...
			success: function(html) {
				...
				$('.loading').fadeOut("fast", function() {
					...
					//$('#gallery-list .item-list').hide().fadeIn();
