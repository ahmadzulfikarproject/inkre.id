        		...
        		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        			<div class="input-group pull-left">
	                	<div class="btn-group is-admin">
	                		<a target="_blank" href="<?php echo base_url('gallery/save'); ?>" class="btn-default btn btn-sm"><i class="fas fa-file-excel"></i> Export xls</a>
	                		<a target="_blank" href="<?php echo base_url('gallery/savepdf'); ?>" class="btn-default btn btn-sm"><i class="fas fa-file-pdf"></i> Export pdf</a>
	                		<a href="<?php echo base_url('gallery/import'); ?>" class="btn-default btn btn-sm"><i class="fas fa-upload"></i> Import</a>

	                	</div>
	                </div>
        			<div class="btn-group pull-right">
                  		<a class='btn btn-primary btn-sm' href='<?php echo base_url(); ?>gallery/tambah_gallery'><i class="fa fa-plus-circle"></i> Tambahkan Data</a>
		        		<a class='btn btn-info btn-sm' href='<?php echo base_url(); ?>gallery/update_semua_gallery'>update slug gallery</a>
		        		<a href="#resetModal" class="btn btn-lg btn-primary btn-sm" data-toggle="modal">Reset gallery DB</a>
		        	</div>
        		</div>
        	</div>
		    <div class="row"> 
		        		...
		        		<tbody>
		        			...
		        			<?php $no = $start; if(!empty($posts)): foreach($posts as $post): ?>
				                ...
				                <tr class="list-item">
				                	<td><?php echo $no+1; ?></td>
				                	<td>
				                		<a href="<?php echo base_url('gallery/edit_gallery/').$post['id_gallery']; ?>"><?php echo $post['judul']; ?></a>
				                	</td>
				                	<td><?php echo $kategori; ?></td>
				                	<td><?php if ($post['gallery_views'] > 0){echo $post['gallery_views'].' Kali';}?></td>
				                	<td><?php echo tanggalindo($post['created_time'],"d-m-Y H:i:s"); //echo tgl_indo($post['tanggal']) ?></td>
				                	<td><center>
			                                <a class='btn btn-success btn-xs' title='Edit Data' href='<?php echo base_url('gallery/edit_gallery/').$post['id_gallery']; ?>'><span class='glyphicon glyphicon-edit'></span></a>
			                                <a class='btn btn-danger btn-xs' title='Delete Data' href='<?php echo base_url('gallery/delete_gallery/').$post['id_gallery']; ?>' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
			                            </center>
		                          	</td>
						        </tr>
	        ...
	        <div class="modal-dialog">
	            <div class="modal-content">
	                ...
	                <div class="modal-footer">
	                    ...
	                    <!--<a id="reset-db" href='<?php //echo base_url('gallery/reset'); ?>' class='btn-default btn btn-sm'>Reset</a>-->
		...
		function searchFilter(page_num) {
		    ...
		    $.ajax({
		        type: 'POST',
		        url: '<?php echo base_url(); ?>gallery/ajaxPaginationData/'+page_num,
