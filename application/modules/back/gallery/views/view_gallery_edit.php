<div class="col-md-12">
    ...
    <?php //echo $rows['judul'];?>
    <div class="box-body">
      <?php   $attributes = array('id'=>'formupload','class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('gallery/edit_gallery',$attributes); ?>
      <div class='col-md-12'>
          <table class='table table-condensed table-bordered'>
            <tbody>
              <input type='hidden' name='id' value="<?php echo $rows['id_gallery'];?>">
              <tr><th width='120px' scope='row'>Judul gallery</th><td><input type='text' class='form-control' name='judul' value="<?php echo $rows['judul'];?>" required></td></tr>
              <tr>
                <th scope='row'>Isi Halaman </th>
                  <td>
                    <textarea id='editor1' class='form-control' name='isi_gallery' style='height:320px'> <?php echo $rows['isi_gallery'] ?></textarea>
                  </td>
              </tr>
              ...
              <tr><th width='120px' scope='row'>Video</th><td>
                <textarea id='video' class='form-control' name='video' style='height:100px' required> <?php echo $rows['video'] ?></textarea>
                <?php echo $rows['video'] ?>
              </td></tr>
              <tr>
                  ...
                  <td>
                    ...
                    <?php if ($rows['gambar'] != ''): ?>
                      ...
                      <div class='row hidden'>
                        <div class='col-md-3'>
                          <img class='current-image' width='100%' src='<?php echo home_url()."asset/foto_gallery/".$rows['gambar']?>'>
                        </div>
                      </div>
                    <?php endif; ?>
                    ...
                    <div id="file-upload">
                      <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                          ...
                          <?php if ($rows['gambar'] != ''): $thumb = getnameimage($rows['gambar'],'_200_400');?>
                            <!--<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href="<?php echo base_url().'/'.webconfig('asset').'/foto_schedules/'.$rows['gambar'] ?>"><?php echo $rows['gambar'] ?></a>-->
                            <img class='current-imagez' width='100%' src='<?php echo home_url()."asset/foto_gallery/".$thumb;?>'>
                          <?php else: ?>
