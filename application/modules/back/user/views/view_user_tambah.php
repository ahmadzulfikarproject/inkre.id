<div class="col-md-12">
    ...
    <div class="box-body">
      <?php   $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('user/tambah_user',$attributes); ?>
      <div class='col-md-12'>
          <table class='table table-condensed table-bordered'>
            <tbody>
              <input type='hidden' name='id' value=''>
              <tr><th width='120px' scope='row'>Judul</th><td><input type='text' class='form-control' name='a'></td></tr>
              <tr><th scope='row'>Isi user</th><td><textarea id='editor1' class='form-control' name='b' style='height:260px'></textarea></td></tr>
    ...
    <div class='box-footer'>
      ...
      <a href='<?php echo base_url('user/user'); ?>'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
