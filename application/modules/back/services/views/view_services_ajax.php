<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      <div class="x_title">
        <h2>Form services <small>halaman services</small></h2>
        <ul class="nav navbar-right panel_toolbox">
          <!-- <li><a href="#resetModal" class="btn btn-lg btn-primary btn-sm" data-toggle="modal">Reset services DB</a></li>
          <li><a class='btn btn-primary' href='<?php echo base_url(); ?>services/add_services'>Tambahkan Data</a></li> -->
          <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
          </li>
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-wrench"></i></a>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#example1').DataTable({
      ...
      buttons: [{
        ...
        action: function(e, dt, node, config) {
          ...
          // window.location.href = '<?php echo base_url("services/tambah_services/"); ?>';
        }
      }]
    });
    ...
    table = $('#table').DataTable({
      ...
      "ajax": {
        "url": "<?php echo site_url('services/ajax_list/') ?>",
        "type": "POST",
        "data": function(data) {
    ...
    $("#reset-db").click(function() {
      ...
      //{
      $.ajax({
        url: '<?php echo base_url("services/reset_services/"); ?>',
        type: 'DELETE',
        beforeSend: function() {
          //$('#enquiryList').hide();
