  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        echo form_open_multipart('services/add_services', $attributes); ?>
            ...
            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="content-tab">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="text" name="tagshasil" id="tagshasil" value="" class="form-control hidden" />
        ...
        <div class="form-group">
          <div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-2">
            ...
            <a href='<?php echo base_url('services'); ?>'><button type='button' class='btn btn-default pull-right'>Cancel</button></a> -->
          </div>
        </div>
