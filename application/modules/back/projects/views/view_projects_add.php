  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        echo form_open_multipart('projects/add_projects', $attributes); ?>
        ...
        <div class="form-group">
          <div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-2">
            ...
            <a href='<?php echo base_url('projects'); ?>'><button type='button' class='btn btn-default pull-right'>Cancel</button></a> -->
          </div>
        </div>
