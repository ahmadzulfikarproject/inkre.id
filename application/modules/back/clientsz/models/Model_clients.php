...
class Model_clients extends CI_model
{
            ...
            if ($media['file_ext'] == '.csv') {
                ...
                foreach ($file_data as $row) {
                    ...
                    if ($ssrc != '') {
                        ...
                        if (!is_dir("../asset/foto_clients/")) {
                            mkdir("../asset/foto_clients/", 0777, TRUE);
                        }
                        //upload gambar
                        /*
                        unset($config);
    ...
    {
        $datadb = array(
            'id_clients' => cetak($this->input->post('a')),
    ...
    */
    ...
    function list_clients_tambah()
    {
        ...
        if ($this->db->insert('clients', $datadb)) {
            ...
            thumb('../asset/foto_clients/' . $hasil['file_name'], '400', '200', false);
            //}
        }
        //fikar tag toxi
        //$ci=& get_instance();
