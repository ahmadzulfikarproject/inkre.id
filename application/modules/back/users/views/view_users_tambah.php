<div class="col-md-12">
      ...
      <div class='col-md-12'>
          <table class='table table-condensed table-bordered'>
            <tbody>
              ...
              <tr><th width='120px' scope='row'>nama_lengkap</th><td><input type='text' class='form-control' name='a'></td></tr>
              <tr><th scope='row'>Isi users</th><td><textarea id='editor1' class='form-control' name='b' style='height:260px'></textarea></td></tr>
              <tr><th scope='row'>usergambar</th>
                <td>
                  <div id="file-upload">
    ...
    <div class='box-footer'>
      ...
      <a href='<?php echo base_url('users/users'); ?>'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
