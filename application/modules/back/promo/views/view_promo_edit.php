    ...
    <div class="x_panel">
      <div class="x_title">
        ...
        <ul class="nav navbar-right panel_toolbox">
          <li><?php echo anchor(home_url('promo/detail/' . $rows['slug']), 'View', array('class' => 'btn btn-success btn-sm', 'target' => '_blank', 'title' => $rows['judul'])); ?>
          </li>
      ...
      <div class="x_content">
        ...
        echo form_open_multipart('promo/edit_promo', $attributes); ?>
          ...
          <div id="myTabContent" class="tab-content">
            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="content-tab">
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type='hidden' name='id' value='<?php echo $rows['id_promo'] ?>'>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea id='editor1' class='form-control' name='b' style='height:260px'><?php echo $rows['isi_promo'] ?></textarea>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  <?php if ($rows['gambar'] != '') : ?>
                    ...
                    <div class='row hidden'>
                      <div class='col-md-3'>
                        <img class='current-image' width='100%' src='<?php echo home_url('asset') . "/foto_promo/" . $rows['gambar'] ?>'>
                      </div>
                    </div>
                  <?php endif; ?>
                  ...
                  <div id="file-upload">
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                      <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                        ...
                        <?php if ($rows['gambar'] != '') : ?>
                          <!--<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href="<?php echo base_url() . '/' . webconfig('asset') . '/foto_schedules/' . $rows['gambar'] ?>"><?php echo $rows['gambar'] ?></a>-->
                          <img class='current-imagez' width='100%' src='<?php echo home_url('asset') . "/foto_promo/" . $rows['gambar'] ?>'>
                        <?php else : ?>
            ...
            <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="seo-tab">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10 col-sm-10 col-xs-12">
                  <input type="text" id="meta-url" class='form-control' palceholder="google link" value="<?php echo home_url('promo/detail/' . $rows['slug']) ?>" readonly />
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">META Description</label>
                <div class="col-md-10 col-sm-10 col-xs-12">
                  <textarea id="meta-desc" type='text' class='form-control' name='meta_description'><?php echo $rows['meta_description'] ? $rows['meta_description'] : character_limiter(strip_tags($rows['isi_promo']), '222') ?></textarea>
                  <input type="text" id="meta-featured-image" class="hidden" value="<?php echo home_url('asset') . "/foto_promo/" . $rows['gambar'] ?>" readonly />
                </div>
              </div>
              <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-2">
            ...
            <a class='btn btn-primary pull-right' href='<?php echo base_url('promo'); ?>'>Cancel</a> -->
          </div>
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#tags').tokenfield({
      autocomplete: {
        source: "<?php echo site_url('promo/get_autocomplete'); ?>",
