<div class="col-md-12">
    ...
    <div class="box-body">
      <?php   $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('products/tambah_products',$attributes); ?>
      <div class='col-md-12'>
             ...
             <tr><th width='120px' scope='row'>Harga</th><td>
              ...
              <tr class="hiddenz">
                <th scope='row'>Kategori</th>
                  <td>
                    <select id="id_kategori" name="id_kategori" class="selectpicker show-tick form-control" data-live-search="true">
