<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      <div class="x_title">
        <h2>Form products <small>halaman products</small></h2>
        <ul class="nav navbar-right panel_toolbox">
          <!-- <li><a href="#resetModal" class="btn btn-lg btn-primary btn-sm" data-toggle="modal">Reset products DB</a></li>
          <li><a class='btn btn-primary' href='<?php echo base_url(); ?>products/add_products'>Tambahkan Data</a></li> -->
          <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
          </li>
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-wrench"></i></a>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#example1').DataTable({
      ...
      buttons: [{
        ...
        action: function(e, dt, node, config) {
          ...
          // window.location.href = '<?php echo base_url("products/tambah_products/"); ?>';
        }
      }]
    });
    ...
    $("#reset-db").click(function() {
      ...
      //{
      $.ajax({
        url: '<?php echo base_url("products/reset_products/"); ?>',
        type: 'DELETE',
        beforeSend: function() {
          //$('#enquiryList').hide();
