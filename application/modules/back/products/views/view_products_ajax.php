        		...
        		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        			<div class="input-group pull-left">
	                	<div class="btn-group is-admin">
	                		<a target="_blank" href="<?php echo base_url('products/save'); ?>" class="btn-default btn btn-sm"><i class="fas fa-file-excel"></i> Export xls</a>
	                		<a target="_blank" href="<?php echo base_url('products/savepdf'); ?>" class="btn-default btn btn-sm"><i class="fas fa-file-pdf"></i> Export pdf</a>
	                		<a href="<?php echo base_url('products/import'); ?>" class="btn-default btn btn-sm"><i class="fas fa-upload"></i> Import</a>

	                	</div>
	                </div>
        			<div class="btn-group pull-right">
                  		<a class='btn btn-primary btn-sm' href='<?php echo base_url(); ?>products/tambah_products'><i class="fa fa-plus-circle"></i> Tambahkan Data</a>
		        		<a class='btn btn-info btn-sm' href='<?php echo base_url(); ?>products/update_semua_products'>update slug products</a>
		        		<a href="#resetModal" class="btn btn-lg btn-primary btn-sm" data-toggle="modal">Reset Products DB</a>
		        	</div>
        		</div>
        	</div>
		    <div class="row"> 
	        ...
	        <div class="modal-dialog">
	            <div class="modal-content">
	                ...
	                <div class="modal-footer">
	                    ...
	                    <!--<a id="reset-db" href='<?php //echo base_url('products/reset'); ?>' class='btn-default btn btn-sm'>Reset</a>-->
