  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        echo form_open_multipart('pages/tambah_pages', $attributes); ?>
            ...
            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="content-tab">
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  <?php $this->template->title = 'Tambah halaman baru '; ?>
                </div>
              </div>
              <div class="form-group row">
        ...
        <div class="form-group">
          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
            ...
            <a href='<?php echo base_url('pages/pages'); ?>'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
          </div>
        </div>
