<div class="col-md-12">
    ...
    <div class="box-body">
      <?php   $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/tambah_contact',$attributes); ?>
      <div class='col-md-12'>
    ...
    <div class='box-footer'>
      ...
      <a href='<?php echo base_url('administrator/contact'); ?>'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
