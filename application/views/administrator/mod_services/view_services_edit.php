<div class="col-md-12">
      ...
      <div class='col-md-12'>
          <table class='table table-condensed table-bordered'>
            <tbody>
              ...
              <tr><th width='120px' scope='row'>Judul services</th><td><input type='text' class='form-control' name='judul' value="<?php echo $rows['judul'];?>" required></td></tr>
              <tr>
                <th scope='row'>Isi Halaman </th>
                  <td>
                    <textarea id='editor1' class='form-control' name='isi_services' style='height:320px' required> <?php echo $rows['isi_services'] ?></textarea>
                  </td>
              </tr>
                  ...
                  <td>
                    ...
                    <?php if ($rows['gambar'] != ''): ?>
                      ...
                      <div class='row hidden'>
                        <div class='col-md-3'>
                          <img class='current-image' width='100%' src='<?php echo base_url().webconfig('asset')."/foto_services/".$rows['gambar']?>'>
                        </div>
                      </div>
                    <?php endif; ?>
                    ...
                    <div id="file-upload">
                      <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                          ...
                          <?php if ($rows['gambar'] != ''): ?>
                            <!--<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href="<?php echo base_url().'/'.webconfig('asset').'/foto_schedules/'.$rows['gambar'] ?>"><?php echo $rows['gambar'] ?></a>-->
                            <img class='current-imagez' width='100%' src='<?php echo base_url().webconfig('asset')."/foto_services/".$rows['gambar']?>'>
                          <?php else: ?>
    ...
    <div class='box-footer'>
      ...
      <a href='<?php echo base_url('administrator/services'); ?>'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
