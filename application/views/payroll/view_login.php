...
<html>
  <head>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>asset/admin/ionicons/css/ionicons.min.css">
    <!-- Theme style -->
  ...
  <body class="hold-transition login-page login" style="background-image: url(<?php echo home_url('asset/'.idwebsite('header')); ?>);">
    <div class="login-box">
      <div class="login-logo">
        <!--<a href="#"><b>ADMIN</b> Login</a>-->
        <a href="<?php echo home_url();?>"><img src="<?php echo home_url().'asset/'.idwebsite('logo'); ?>"><b>ADMIN</b> Login</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="password" class="form-control" name='b' placeholder="Password" required autocomplete="off">
