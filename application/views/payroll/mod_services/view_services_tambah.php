<div class="col-md-12">
    <div class="box box-info">
        <div class='box-header with-border'>
          <h3 class='box-title'>Tambah services Baru</h3>
        </div>
    </div>
    <div class="box-body">
      ...
      <div class='col-md-12'>
          <table class='table table-condensed table-bordered'>
            <tbody>
              ...
              <tr><th scope='row'>Isi services</th><td><textarea id='editor1' class='form-control' name='isi_services' style='height:260px'></textarea></td></tr>
