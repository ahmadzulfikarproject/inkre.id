<div class="col-md-12">
    ...
    <div class="box-body">
      <?php   $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('administrator/edit_slidebaru',$attributes); ?>
      <div class='col-md-12'>
          <table class='table table-condensed table-bordered'>
            <tbody>
              ...
              <tr><th scope='row'>Isi slide</th><td><textarea id='editor1' class='form-control' name='b' style='height:260px'><?php echo $rows['isi_slide']?></textarea></td></tr>
              <tr>
                  ...
                  <td>
                    ...
                    <?php if ($rows['gambar'] != ''): ?>
                      ...
                      <div class='row hidden'>
                        <div class='col-md-3'>
                          <img class='current-image' width='100%' src='<?php echo base_url().webconfig('asset')."/foto_slide/".$rows['gambar']?>'>
                        </div>
                      </div>
                    <?php endif; ?>
                    ...
                    <div id="file-upload">
                      <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                          ...
                          <?php if ($rows['gambar'] != ''): ?>
                            <!--<i style='color:red'>Lihat Gambar Saat ini : </i><a target='_BLANK' href="<?php echo base_url().'/'.webconfig('asset').'/foto_schedules/'.$rows['gambar'] ?>"><?php echo $rows['gambar'] ?></a>-->
                            <img class='current-imagez' width='100%' src='<?php echo base_url().webconfig('asset')."/foto_slide/".$rows['gambar']?>'>
                          <?php else: ?>
    ...
    <div class='box-footer'>
      ...
      <a href='<?php echo base_url('administrator/slide'); ?>'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
