...
<feed xmlns="http://www.w3.org/2005/Atom" <?php foreach ($namespaces as $n) echo " " . $n; ?>>
    ...
    <subtitle type="html">
        <![CDATA[<?php echo $channel['description'] ?>]]>
    </subtitle>
    <link href="<?php echo $channel['link'] ?>">
    </link>
    <id><?php echo $channel['link'] ?></id>
    <link rel="alternate" type="text/html" href="<?php echo $channel['link'] ?>">
    </link>
    <link rel="self" type="application/atom+xml" href="<?php echo $channel['link'] ?>">
    </link>
