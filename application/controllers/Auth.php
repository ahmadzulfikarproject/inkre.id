...
class Auth extends MY_AdminController
{
	...
	public function index()
	{
		...
		} else if (!$this->ion_auth->is_admin()) // remove this elseif if you want to enable this for non-admins
		{
			...
			//$this->template->load('administrator/template','administrator/view_index',$this->data);
			// $this->template->load('administrator/template', 'auth' . DIRECTORY_SEPARATOR . 'index', $this->data);
	...
	public function change_password()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			$this->template->load('administrator/template', 'auth' . DIRECTORY_SEPARATOR . 'change_password', $this->data);
		} else {
	...
	public function create_user()
	{
		...
		if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
			...
			// $this->template->load('administrator/template', 'auth' . DIRECTORY_SEPARATOR . 'create_user', $this->data);
			$this->template->title = $this->data['title'];
	...
	public function edit_user($id)
	{
		...
		// $this->template->load('administrator/template', 'auth' . DIRECTORY_SEPARATOR . 'edit_user', $this->data);
		$this->template->title = $this->data['title'];
	...
	public function create_group()
	{
		...
		if ($this->form_validation->run() === TRUE) {
			...
			// $this->template->load('administrator/template', 'auth' . DIRECTORY_SEPARATOR . 'create_group', $this->data);
			$this->template->title = $this->data['title'];
	...
	public function edit_group($id)
	{
		...
		// $this->template->load('administrator/template', 'auth' . DIRECTORY_SEPARATOR . 'edit_group', $this->data);
		$this->template->title = $this->data['title'];
